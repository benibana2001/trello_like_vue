...
//               expect(wrapper.find('.validation') .vm.$data.validation.email.required).toBeFalsy();
//             });
//           });
...
//               expect(wrapper.vm.$data.validation.email.format).toBeFalsy();
//             });
//             it('validation.email.format is valid', () => {
//               wrapper.setData({ email: 'foo@bar.com' });
//               expect(wrapper.vm.$data.validation.email.format).toBeTruthy();
//             });
//           });
//         });
//       });
...
//               expect(wrapper.vm.$data.validation.password.required).toBeFalsy();
//             });
//           });
...
//               expect(
//                 wrapper.vm.$data.validation.password.required
//               ).toBeTruthy();
//             });
//           });
//         });
...
//         expect(wrapper.vm.$data.disableLobinAction).toBeTruthy();
//       });
//     });
...
//       expect(wrapper.vm.$data.disableLoginAction).toBeFalsy();
//     });
...
//         expect(wrapper.vm.$data.disableLoginAction).toBeTruthy();
//       });
//     });
//   });
